    ...
    <div className="w-full max-w-sm">
      <div className="mb-8 flex flex-col items-center gap-3">
        ...
        <p className="text-muted-foreground text-center text-sm">
          Get started with JiraClaw in seconds
        </p>
      </div>

      <div className="flex flex-col gap-3">
        <Button variant="outline" className="h-11 w-full gap-3 text-sm" onClick={handleOAuthSignUp}>
      ...
      <p className="text-muted-foreground mt-4 text-center text-[10px] leading-relaxed">
        By creating an account, you agree to JiraClaw{"'"}s{" "}
        <Link
          href="/terms"
