...
export default function TermsOfServicePage() {
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-12">
      ...
      <h1 className="text-foreground text-2xl font-bold tracking-tight">Terms of Service</h1>
      ...
      <div className="text-muted-foreground mt-8 flex flex-col gap-6 text-sm leading-relaxed">
        ...
        <section className="flex flex-col gap-2">
          ...
          <p>
            JiraClaw is an AI-powered Jira automation platform that enables users to create bots,
            integrate with Jira projects, configure AI models, manage communication channels, and
        ...
        <section className="flex flex-col gap-2">
          ...
          <p>
            You must create an account using a supported authentication provider (Google or GitHub)
            to use the Service. You are responsible for maintaining the security of your account
        ...
        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">5. Subscription and Billing</h2>
          <p>
            Some features of the Service require a paid subscription. Billing occurs on a monthly
            basis. You may cancel your subscription at any time, and access will continue until the
            end of the current billing period. Refunds are not provided for partial billing periods.
          </p>
        </section>

        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">6. Data and Privacy</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">7. Intellectual Property</h2>
          <p>
            The Service, including its original content, features, and functionality, is owned by
            JiraClaw and is protected by international copyright, trademark, and other intellectual
            property laws.
          </p>
        </section>

        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">8. Limitation of Liability</h2>
          <p>
            The Service is provided &quot;as is&quot; without warranties of any kind. In no event
            shall JiraClaw be liable for any indirect, incidental, special, consequential, or
            punitive damages arising from your use of the Service.
          </p>
        </section>

        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">9. Termination</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">10. Changes to Terms</h2>
          <p>
            We reserve the right to modify these Terms at any time. We will notify users of material
            changes by posting the updated Terms on the Service. Your continued use of the Service
            after such changes constitutes acceptance of the new Terms.
          </p>
        </section>

        <section className="flex flex-col gap-2">
          <h2 className="text-foreground text-base font-semibold">11. Contact</h2>
          <p>
            If you have any questions about these Terms, please contact us at{" "}
            <span className="text-foreground font-medium">legal@jiraclaw.ai</span>.
          </p>
        </section>
      </div>
    </div>
